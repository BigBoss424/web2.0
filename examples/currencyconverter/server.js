...
const { ConvertCurrency, convertCurrency } = require('./lib/free-currency-service');
...
const errorHandler = (err, req, res) => {
   if(err.response){
      ...
      res.status(403).send({title: 'Server responded with and error', message: err.message});
   }else if(err.request) {
...
//    const data = await convertCurrency('USD', 'BTC');
//    console.log(data);
// }
