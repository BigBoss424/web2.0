...
if("undefined"==typeof r.data("html-top")&&r.data("html-top",parseInt(r.css("top"),10)).data("offset",this.cache_offset(r)),this.key_up_on(r),r.trigger("open").trigger("open.fndtn.reveal"),a.length<1&&this.toggle_bg(r,!0),"string"==typeof i&&(i={url:i}),"undefined"!=typeof i&&i.url){var l="undefined"!=typeof i.success?i.success:null
...
var l={top:e(o).scrollTop()+t.data("html-top")+"px",opacity:1}
return setTimeout(function(){return t.css(n).animate(l,i.animation_speed,"linear",function(){this.locked=!1,t.trigger("opened").trigger("opened.fndtn.reveal")}.bind(this)).addClass("open")}.bind(this),i.animation_speed/2)}if(a.fade){n.top=e(o).scrollTop()+t.data("html-top")+"px"
var l={opacity:1}
