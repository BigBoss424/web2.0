  ...
  <section class="flex flex-col flex-wrap items-center bg-gray-400 pt-8 animated fade-in">
    <div class="justify-around items-center w-5/6 md:w-1/2 mx-auto pb-8 md:pb-0">
      ...
      <p class="text-base md:text-lg text-gray-700 leading-normal">
        I'm <span class="text-gray-900" v-text="'Aaron'" />, a guy in his twenties living in
        <span class="text-gray-900" v-text="'Washington, United States'" />. Already at young age, computers impressed me
        ...
        <br><br>
        When developing web apps, I mostly rely on the <span class="text-gray-900" v-text="'Node.js'" />
        framework for the backend.
        In terms of frontend, <span class="text-gray-900" v-text="'Jekyll'" /> is my favorite choice,
    ...
    <VueNextLevelScroll class="cursor-pointer hidden md:block" target="#skills">
      <Icon
        class="md:my-4 animated infinite bounce-nice animation-duration-4000 fill-current text-gray-700"
