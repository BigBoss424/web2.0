<template>
  <section class="flex flex-wrap bg-gray-200 py-6 md:py-10">
    <div class="flex flex-col justify-around items-center w-5/6 md:w-1/2 mx-auto text-center animated zoom-in">
      <picture>
        <source srcset="/img/avatar@2x.webp 2x" type="image/webp">
        <source srcset="/img/avatar.webp 2x" type="image/webp">
        <source srcset="/img/avatar@2x.jpg 2x" type="image/jpeg">
        <source srcset="/img/avatar.jpg" type="image/jpeg">
        <img
          alt="Young man (Aaron Jones) wearing a suite, nature in the background"
      ...
      <div class="flex mt-4">
        <a
          ...
          href="https://github.com/bigboss424"
        ...
        <a
          ...
          href="mailto:ajones061392@yahoo.com"
          rel="noreferrer noopener"
        ...
        <a
          ...
          href="https://twitter.com/Heeroyuy424"
          rel="noreferrer noopener"
          target="_blank"
