<template>
  ...
  <section class="flex flex-col flex-wrap items-center bg-gray-lighter py-8 leading-normal text-gray-darkest">
    <div class="justify-around items-center w-5/6 md:w-1/2 mx-auto">
      ...
      Information in accordance with section 5 DMCA
      <br>
      <br>
      Cogs Web Development and Hosting<br>
      3536 McNally Ave<br>
...
<!--      Other Persons-->
      <br><br>
      <h2>Contact</h2>
      E-Mail: <a href="mailto:ajones061392@yahoo.com">
        ajones061392@yahoo.com
      </a>
      <br>
      Website: <a href="https://www.jportfolio.tk/" target="_blank" rel="noopener">
        www.jportfolio.tk/
      </a><br>
      Website: <a href="https://www.cogswebdevandhosting.ml/" target="_blank" rel="noopener">
        www.cogswebdevandhosting.ml
      </a>
      <br>
      <h2>VAT number</h2>
