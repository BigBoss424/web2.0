<template>
  <div class="container mx-auto px-4 my-8 min-h-screen">
    ...
    <h3 class="font-normal text-xl py-4">
      Who is responsible for the collection of data on jPortfolio.tk?
    </h3>
    <p>
      That's me, or better said my company: Cogs Web Development and Hosting.
        Our contact data can be found in the
      <NuxtLink
        to="/legal/"
        rel="nofollow"
        v-text="'legal notice'"
    ...
    <p>
      ...
      media).<br>
      Furthermore we collect data anonymize through Google Analytics (see 3.). We do not collect any personal
      data.<br>
    ...
    <p>
      ...
      But as we don't save any personal data through jPortfolio.tk, we will likely tell you that we don't have any data
      about you.<br>
      <br>
    ...
    <p>
      ...
      concerning our Website usage so we can further optimize jPortfolio.tk (see 3.).<br>
    ...
    <p>
      ...
      In this context, pseudonymous user profiles are created and cookies (see 2.) are used.<br>
    ...
    <ul>
      ...
      <li>Current page</li>
      <li>Anonymize IP address</li>
      <li>Time of request</li>
    </ul>
    <br>
    <p>
      The information will be used to analyze the usage of jPortfolio.tk, to create reports about the user’s activity
