/*!
 * @nuxt/webpack-edge v2.11.1-26378723.c5d0067 (c) 2016-2020
...
class StyleLoader {
  ...
  styleResource (ext) {
    ...
    const patterns = utilsEdge.wrapArray(extResource).map(p => path.resolve(rootDir, p));
...
class WebpackBaseConfig {
  ...
  getBabelOptions () {
    ...
    const defaultPreset = [require.resolve('@nuxt/babel-preset-app-edge'), {}];
  ...
  output () {
    ...
    return {
      ...
      publicPath: utilsEdge.isUrl(publicPath) ? publicPath : utilsEdge.urlJoin(router.base, publicPath)
    }
  }
