let build,head,manifest,meta,render,utils;_a49‍.x([["default",()=>_a49‍.o]]);_a49‍.w("./config",[["build",["build"],function(v){build=v}],["head",["head"],function(v){head=v}],["manifest",["manifest"],function(v){manifest=v}],["meta",["meta"],function(v){meta=v}],["render",["render"],function(v){render=v}],["utils",["utils"],function(v){utils=v}]]);
