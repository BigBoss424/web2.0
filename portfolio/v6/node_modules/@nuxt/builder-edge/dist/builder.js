/*!
 * @nuxt/builder-edge v2.11.1-26378723.c5d0067 (c) 2016-2020
...
class Builder {
  ...
  getBundleBuilder (BundleBuilder) {
    ...
    if (typeof BundleBuilder !== 'function') {
      ({ BundleBuilder } = require('@nuxt/webpack-edge'));
    }
  ...
  async build () {
    ...
    await fsExtra.remove(utilsEdge.r(this.options.buildDir));
    const buildDirs = [utilsEdge.r(this.options.buildDir, 'components')];
    if (!this.options.dev) {
      buildDirs.push(
        utilsEdge.r(this.options.buildDir, 'dist', 'client'),
        utilsEdge.r(this.options.buildDir, 'dist', 'server')
      );
    }
  ...
  async resolveLayouts ({ templateVars, templateFiles }) {
    ...
    if (!templateVars.layouts.default) {
      await fsExtra.mkdirp(utilsEdge.r(this.options.buildDir, 'layouts'));
    ...
    await Promise.all(
      templateFiles.map(async (templateFile) => {
        ...
        try {
          ...
          content = utilsEdge.stripWhitespace(
            templateFunction({
              ...templateVars,
              ...templateFile
            })
