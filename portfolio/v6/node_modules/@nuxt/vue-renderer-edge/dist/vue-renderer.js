/*!
 * @nuxt/vue-renderer-edge v2.11.1-26378723.c5d0067 (c) 2016-2020
...
class SPARenderer extends BaseRenderer {
  ...
  async render (renderContext) {
    ...
    const modern = (modernMode && _generate) || utilsEdge.isModernRequest(req, modernMode);
...
class ModernRenderer extends SSRRenderer {
  constructor (serverContext) {
    ...
    this.publicPath = utilsEdge.isUrl(publicPath) ? publicPath : utilsEdge.urlJoin(base, publicPath);
  }
