/*!
 * @nuxt/core-edge v2.11.1-26378723.c5d0067 (c) 2016-2020
...
class ModuleContainer {
  ...
  async ready () {
    ...
    if (this.options.buildModules && !this.options._start) {
      ...
      await utilsEdge.sequence(this.options.buildModules, this.addModule.bind(this));
    }

    // Load every module in sequence
    await utilsEdge.sequence(this.options.modules, this.addModule.bind(this));
  ...
  extendRoutes (fn) {
    this.options.router.extendRoutes = utilsEdge.chainFn(
...
Object.defineProperty(exports, 'loadNuxtConfig', {
  enumerable: true,
  get: function () {
    return configEdge.loadNuxtConfig;
  }
});
