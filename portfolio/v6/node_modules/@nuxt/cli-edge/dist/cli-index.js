/*!
 * @nuxt/cli-edge v2.11.1-26378723.c5d0067 (c) 2016-2020
...
const builder = () => _import('@nuxt/builder-edge');
const webpack = () => _import('@nuxt/webpack-edge');
const generator = () => _import('@nuxt/generator-edge');
const core = () => _import('@nuxt/core-edge');
...
const common = {
  ...
  'config-file': {
    ...
    description: `Path to Nuxt.js config file (default: \`${configEdge.defaultNuxtConfigFile}\`)`
  },
  modern: {
    alias: 'm',
    type: 'string',
...
var version = "2.11.1-26378723.c5d0067";
